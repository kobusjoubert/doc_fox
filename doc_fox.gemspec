...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/kobusjoubert/dox_fox'
  spec.metadata['changelog_uri'] = 'https://github.com/kobusjoubert/dox_fox/blob/main/CHANGELOG.md'
